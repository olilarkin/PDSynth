...
NOTARIZE_BUNDLE_ID=com.OliLarkin.PDSynth
NOTARIZE_BUNDLE_ID_DEMO=com.OliLarkin.PDSynth.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/PDSynth.iss
#  git checkout installer/PDSynth.pkgproj
