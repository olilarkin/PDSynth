...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=PDSynth Demo Installer\n"
      else:
        line="OutputBaseFilename=PDSynth Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the PDSynth Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the PDSynth installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=PDSynth Demo installer\n"
     else:
       line="SetupWindowTitle=PDSynth installer\n"
